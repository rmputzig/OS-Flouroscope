include <most-scad-libraries-master/fasteners.scad>
include <most-scad-libraries-master/bearings.scad>
include <most-scad-libraries-master/NEMA17.scad>
include <most-scad-libraries-master/cog.scad>
include <most-scad-libraries-master/Triangles.scad>
include <most-scad-libraries-master/hotends.scad>
include <most-scad-libraries-master/cog.scad>
...
difference(){
	union(){
	cylinder(h=20,r=19/2,center=true);
	translate([0,0,-10]){
	cube(size=[24,24,1,],center=true);
	}
	}
cylinder(h=21,r=8.5,center=true);
}
}
